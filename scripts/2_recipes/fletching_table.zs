...
public class fletchingTableRecipeExtended {
	...
	public registerRecipe() as void {
		...
		this.name = NameUtil.fixing("ct_fletching_" + this.output.registryName);
...
val fletchingRecipes as fletchingTableRecipeExtended[] = [
	...
	new fletchingTableRecipeExtended(<item:xtraarrows:incendiary_arrow>, [<item:minecraft:blaze_powder>, <tag:items:forge:rods/blaze>, <tag:items:forge:feathers>], true),
